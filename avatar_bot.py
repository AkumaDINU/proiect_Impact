...
def start(update, context):
    context.bot.send_message(chat_id=update.effective_chat.id, text="Welcome to the Avatar Bot! Please send your name to generate your unique avatar.")
    keyboard = [[InlineKeyboardButton("Generate Avatar", callback_data='generate_avatar')]]
    reply_markup = InlineKeyboardMarkup(keyboard)
    context.bot.send_message(chat_id=update.effective_chat.id, text='Click the button to generate your avatar!', reply_markup=reply_markup)
